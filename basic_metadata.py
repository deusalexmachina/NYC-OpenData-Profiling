...
def test():
    ...
    def run(spark, df, master_itemset, iteration):
        ### MAIN ###
        ...
        # APPENDED CODE
        df_output, df_itemset = get_dataset_profile(spark, df_cols)
        dct['dataset_profile'] = df_output
        dct['itemset'] = df_itemset
